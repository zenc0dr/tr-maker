...
+function ($) { "use strict";
    ...
    DateFilter.prototype.initDatePickers = function() {
        ...
        this.$pickers.each(function(index, datepicker) {
            var $datepicker = $(datepicker),
                defaultValue = self.getDataLocker($datepicker);
    ...
    DateFilter.prototype.onSelectDatePicker = function(datepicker, $input) {
        var pickerMoment = datepicker.getMoment(),
            pickerValue = pickerMoment.format(this.dbDateFormat);

        var momentObj = moment
            .tz(pickerValue, 'YYYY-MM-DD', this.timezone)
            .tz(this.appTimezone);

        var lockerValue = momentObj.format('YYYY-MM-DD');
