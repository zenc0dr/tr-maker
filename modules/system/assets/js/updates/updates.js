...
class UpdateList extends oc.FoundationBase
{
    constructor(element, config) {
        super(element, config);

        this.listen('click', '[data-updatelist-check]', this.proxy(this.checkForUpdates));
        this.checkForUpdates(true);
    }

    dispose() {
        this.forget('click', '[data-updatelist-check]', this.proxy(this.checkForUpdates));
        super.dispose();
    }
