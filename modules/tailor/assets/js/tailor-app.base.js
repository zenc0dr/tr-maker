$.oc.module.register('tailor.app.base', function () {
    'use strict';

    const VueApp = $.oc.module.import('backend.october.vueapp');
    ...
    class TailorAppBase extends VueApp {
        ...
        initListeners() {
            // Listen for Turbo
            addEventListener('before-render', () => this.refreshToolbars());

            // Listen for AJAX
            $(window).on('oc.updateUi', () => this.refreshToolbars());
