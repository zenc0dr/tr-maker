...
class EditorExtension extends ExtensionBase
{
    ...
    use \Tailor\Traits\EditorExtensionState;
    use \Tailor\Traits\EditorExtensionCrud;
    ...
    {
        return [
            '/modules/tailor/assets/js/tailor.editor.extension.js' => 'core',
            '/modules/tailor/assets/js/tailor.editor.extension.documentcomponent.base.js' => 'core',
            '/modules/tailor/assets/js/tailor.editor.extension.documentcontroller.blueprint.js' => 'core'
        ];
    }
